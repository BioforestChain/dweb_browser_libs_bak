...
cp -r ./target/aarch64-apple-darwin/release/libgeolocation.a ../src/desktopMain/resources/darwin-aarch64/
cp -r ./target/aarch64-apple-darwin/release/libgeolocation.dylib ../src/desktopMain/resources/darwin-aarch64/libgeolocation.dylib
mkdir -p ../src/desktopMain/resources/darwin-x86-64/
cp -r ./target/x86_64-apple-darwin/release/libgeolocation.a ../src/desktopMain/resources/darwin-x86-64/
cp -r ./target/x86_64-apple-darwin/release/libgeolocation.dylib ../src/desktopMain/resources/darwin-x86-64/
...
# cp -r ./target/x86_64-pc-windows-gnu/release/geolocation.dll ../src/desktopMain/resources/win32-x86-64/
